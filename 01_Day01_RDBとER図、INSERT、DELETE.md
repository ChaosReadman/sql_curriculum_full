...
- [🎯 目次](#-目次)
- [📝 内容詳細](#-内容詳細)
  - [1. リレーショナルデータベース（RDB）の基本概念](#1-リレーショナルデータベースrdbの基本概念)
  - [2. ER図とは](#2-er図とは)
  - [3. dbdiagramの使い方](#3-dbdiagramの使い方)
  - [4. SQL ServerにER図を適用する](#4-sql-serverにer図を適用する)
  - [5. ダミーデータの挿入](#5-ダミーデータの挿入)
...
## 5. SQLのINSERT文でダミーデータの挿入
   - INSERT文の基本
     - `INSERT INTO テーブル名 (カラム1, カラム2, ...) VALUES (値1, 値2, ...);`

   - このINSERT文の基本を使い、作成したテーブルにダミーデータを挿入して、データベースの動作を確認します。
